...
public abstract class QryIop extends Qry {
  ...
  public int docIteratorGetMatch () {
	//System.out.println("q0.docGetmatch "+ this.getClass());
  ...
  public boolean docIteratorHasMatch (RetrievalModel r) {
	//System.out.println(this.getClass()+": "+this.docIteratorIndex);
	//System.out.println(this.getClass()+" iList: "+this.invertedList.df);
 ...
 /**
  ...
  public int getdocIteratorMatchTf(){
	//  System.out.println(this.getClass());
	  System.out.println("docIteratorIndex: "+this.docIteratorIndex);
	  int a;
	  a = this.invertedList.getTf(this.docIteratorIndex);
